    ...
    <div className="container-fluid stiiksy">
      <nav className="navbar navbar-expand-lg" >
        ...
        <Row className="d-flex asjadkandk justify-conetent-between">
          ...
          <Button  className='walletbtnmob myyyyy'><i className="fas fa-wallet"><span style={{fontFamily:'myFirstFont', fontStyle:'initial',fontWeight:'200'}}>&nbsp;&nbsp;CONNECT</span></i></Button>
          <button
        id="nave"
